...
export const users: User[] = [
  { id: "u_sales_shirley", name: "Shirley", email: "shirley@cardbot.com", password: "cardbot123", role: "sales", teamId: "europe", avatar: "SH", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Shirley", emailSignature: "Best regards,\\nShirley\\nCardBot Sales Team" },
  { id: "u_sales_mia", name: "Mia", email: "mia@cardbot.com", password: "cardbot123", role: "sales", teamId: "europe", avatar: "MI", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Mia", emailSignature: "Best regards,\\nMia\\nCardBot Sales Team" },
  { id: "u_manager_alex", name: "Alex", email: "alex@cardbot.com", password: "cardbot123", role: "manager", teamId: "europe", avatar: "AL", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Alex", emailSignature: "Best regards,\\nAlex\\nCardBot Sales Team" },
  { id: "u_admin", name: "Admin", email: "admin@cardbot.com", password: "cardbot123", role: "admin", teamId: "europe", avatar: "AD", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Admin", emailSignature: "CardBot Admin" },
  { id: "u_super_admin", name: "Super Admin", email: "super@cardbot.com", password: "cardbot123", role: "super_admin", teamId: "all", avatar: "SA", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Super Admin", emailSignature: "CardBot" }
];
...
export const todos: Todo[] = [
  { id: "t1", title: "补发 Nordic Tools AB 的 CE 证书与新版交期说明", type: "customer", priority: "high", status: "pending", pinState: "", sortOrder: 10, dueAt: "今天 09:45", ownerId: "u_sales_shirley", teamId: "europe", related: "Nordic Tools AB", done: false, impactAmount: 36000, workStatus: "needs_confirmation", sourceRefs: [{ id: "src_mail_nordic", type: "customer_email", sourceId: "mail_nordic_20260911", label: "Nordic Tools AB 客户邮件", excerpt: "请补充 CE 证书，并确认新版交期。", occurredAt: "2026-09-11T00:20:00.000Z" }], statusEvents: [], completionEvidence: [], workdayAssignments: [], completionCriteria: "CE 证书与交期说明形成草稿并通过人工审核", nextAction: "向供应链确认新版交期", blocker: "交期尚未由供应链确认" },
  ...
  { id: "t4", title: "复核 OCR 名片识别结果并同步 8 条展会线索", type: "ocr", priority: "normal", status: "pending", pinState: "", sortOrder: 40, dueAt: "今天 16:20", ownerId: "u_sales_shirley", teamId: "europe", related: "OCR 线索", done: false, workStatus: "pending", sourceRefs: [{ id: "src_manager_ocr", type: "manager_assignment", sourceId: "assignment_ocr_20260911", label: "主管工作安排", excerpt: "下班前复核展会名片并同步 8 条有效线索。", occurredAt: "2026-09-11T00:35:00.000Z" }], statusEvents: [], completionEvidence: [], workdayAssignments: [], completionCriteria: "8 条线索全部复核并同步", nextAction: "逐条核对公司与邮箱" },
