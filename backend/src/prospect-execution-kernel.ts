...
export class ProspectExecutionKernel {
  ...
  constructor(options: ProspectExecutionKernelOptions) {
    ...
    const providerRequestIdempotencySecret =
      ...
      || createHmac("sha256", options.claimSecret)
        .update("cardbot-provider-request-idempotency-v1")
        .digest("hex");
    ...
    const providerRequestEnvelopeSecret =
      ...
      || createHmac("sha256", options.claimSecret)
        .update("cardbot-provider-request-envelope-v1")
        .digest("hex");
    ...
    const providerResponseEnvelopeSecret =
      ...
      || createHmac("sha256", options.claimSecret)
        .update("cardbot-provider-response-envelope-v1")
        .digest("hex");
    ...
    const providerRawEnvelopeSecret =
      ...
      || createHmac("sha256", options.claimSecret)
        .update("cardbot-provider-raw-envelope-v1")
        .digest("hex");
    ...
    const providerRawIdentitySecret =
      ...
      || createHmac("sha256", options.claimSecret)
        .update("cardbot-provider-raw-identity-v1")
        .digest("hex");
    ...
    this.providerRequestEnvelopeKey = createHash("sha256")
      .update("cardbot-provider-request-envelope-key-v1\u001f")
      .update(providerRequestEnvelopeSecret)
      .digest();
    this.providerResponseEnvelopeKey = createHash("sha256")
      .update("cardbot-provider-response-envelope-key-v1\u001f")
  ...
  >) {
    return Buffer.from([
      "cardbot-prospect-strategy-source-position-cursor-v1",
      position.id,
