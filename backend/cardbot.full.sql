-- CardBot development-only MySQL initialization script.
-- Open-source safe: schema only. Never point this file at a personal database.

DROP DATABASE IF EXISTS cardbot_dev;
CREATE DATABASE cardbot_dev CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE cardbot_dev;
