...
APP_ROOT="${APP_ROOT:-/opt/cardbot}"
APP_USER="${APP_USER:-cardbot}"
SERVICE_NAME="${SERVICE_NAME:-cardbot}"
DB_NAME="${DB_NAME:-cardbot}"
DB_USER="${DB_USER:-cardbot}"
...
usage() {
  cat <<'EOF'
CardBot Ubuntu 无 Docker 一键部署脚本
