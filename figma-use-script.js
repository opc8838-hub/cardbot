// CardBot Figma MCP use_figma script
...
const app = makeFrame("CardBot Web Prototype", 1440, 1320, { r: 237 / 255, g: 242 / 255, b: 247 / 255 });
app.x = 120;
app.y = 80;
...
const brand = makeText("Brand", "CardBot\n外贸客户增长中台", 16, "Bold", colors.white);
