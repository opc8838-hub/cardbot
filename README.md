...
2026-09-12 更新：多语言问候 → 小字拼成 CARD 的功能页 → 左侧导航的企业工作台。支持中英文、黑白主题、文字地球与世界时钟、任务与邮件依据、人工审核、一键播放七步业务演练，以及可由每个演示账号单独选择的扑克牌 Bot。点击 logo 右侧的 Bot 可选择 16 种表情和 12 种颜色，并打开可缩小/关闭的企业知识助手演示；全部回答是本地预置内容，不调用真实知识库、模型或小满。
