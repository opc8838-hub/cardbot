...
2026-09-12 交付：多语言问候 → 小字拼成 CARD 的功能页 → 无需登录的交互工作台。支持中英文一键切换、浅色/深色、文字大陆地球、全球时区实时时钟、早晚同批任务、查看邮件来源、人工确认完成、审核与本地草稿、管理汇总，以及企业管理员/业务员身份切换 Demo。
...
6. 顶部“演示身份”可切换经理和三位业务员：经理看团队及企业映射，每位业务员只看自己的任务；不属于自己的邮件草稿会显示权限边界。
7. Team 汇总与个人视图共用同一份状态；Connect 明确显示哪些接入尚未完成。
